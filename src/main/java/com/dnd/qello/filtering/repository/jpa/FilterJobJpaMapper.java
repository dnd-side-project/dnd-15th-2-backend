...
final class FilterJobJpaMapper {
	...
	static FilterJob toDomain(FilterJobJpaEntity entity) {
		...
		return FilterJob.restore(entity.getId(), target, entity.getFilterReleaseId(), entity.getStatus(),
			entity.getAttemptGeneration(), entity.getLogicalAttemptCount(), entity.isManuallyResolved(),
			entity.getResolvedVerdict(), entity.getIdempotencyKey(), entity.getDeadlineAt(), entity.getCreatedAt(),
			entity.getUpdatedAt());
	}
}
