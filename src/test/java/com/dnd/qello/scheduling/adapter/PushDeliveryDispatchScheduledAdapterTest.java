...
class PushDeliveryDispatchScheduledAdapterTest {
	...
	void recordsClaimedAndEveryPushOutcome() {
		...
		assertThat(counter(registry, WorkerMetrics.OUTCOME_TOTAL, "push_delivery_dispatch", "SENT").count())
				.isEqualTo(1.0);
		assertThat(counter(registry, WorkerMetrics.OUTCOME_TOTAL, "push_delivery_dispatch", "RETRY_SCHEDULED").count())
				.isEqualTo(1.0);
		assertThat(counter(registry, WorkerMetrics.OUTCOME_TOTAL, "push_delivery_dispatch", "DEAD").count())
				.isEqualTo(1.0);
